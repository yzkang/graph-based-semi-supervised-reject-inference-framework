...
# Licence: GPL
# Desc: Reject inference using label spreading algorithm
...
def baseline_labelspreading_new(data_path, bad_sample_num, good_sample_num, reject_sample_num, random_state_for_each_epoch, classifier, resampling_model):
    """
    ...
    y_predict = classifier.fit(X_train_and_reject, y_train_and_reject_1).predict(X_test)
