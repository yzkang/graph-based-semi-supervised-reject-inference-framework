...
def baseline(data_path, bad_sample_num, good_sample_num, reject_sample_num, random_state_for_each_epoch, classifier, resampling_model):
    """
    ...
    # data_all = pd.concat([data_bad, data_good], axis=0)
    ...
    # print(y_predict[y_predict == 1].sum())
