...
def baseline_resampling_labelspreading(data_path, bad_sample_num, good_sample_num, reject_sample_num, random_state_for_each_epoch, classifier, resampling_model):
    """
    The proposed model
    :param data_path: the path of the data file for test
    :param bad_sample_num: the number of bad examples
    :param good_sample_num: the number of good examples
    :param reject_sample_num: the number of rejected examples
    :param random_state_for_each_epoch: random seed for sampling
    :param classifier: a binary classifier for training, such as LR, SVM, Random Forest, XGBoost, LightGBM
    :param resampling_model: the method for resample data
