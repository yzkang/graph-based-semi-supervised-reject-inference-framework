...
# Licence: GPL
# Desc: Reject inference using “Define as bad” (RI-DAB)
...
def baseline_all_1(data_path, bad_sample_num, good_sample_num, reject_sample_num, random_state_for_each_epoch, classifier, resampling_model):
    """
    ...
    # print(data_bad.shape, data_good.shape, data_reject.shape)
    ...
    X = data_train_randomized.drop(['label'], axis=1).iloc[:, :].as_matrix()  
